        ...
        <>
            ...
            <Modal show={show} onHide={handleClose} className={`${niramit.className}`}>
                ...
                <Modal.Body>
                    ...
                    <p>Send us a YouTube link to a video you&rsquo;d like to see added. We&rsquo;ll review and consider adding it! <a href="mailto:suggestions@timetraveltelevision.com">suggestions@timetraveltelevision.com</a></p>
                    <hr/>
                    ...
                    <form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_blank">
                        ...
                        <input type="hidden" name="hosted_button_id" value="W4W36HRRTZFMG"/>
